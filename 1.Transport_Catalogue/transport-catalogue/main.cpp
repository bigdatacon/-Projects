...
int main(int argc, char* argv[]) {
    ...
    if (mode == "make_base"sv) {
        ...
        serialization::CatalogueSerialize(tc, rd , routeSettings, out_file);
        ...
        auto catalogue = serialization::CatalogueDeserialize(in_file);
        ...
        transport_catalogue::graph::ActivityProcessor activityprocessor(tc);
